...
import com.platform.common.utils.gen.config.GenConfig;
...
public class GenUtils {
    ...
    public static String convertClassName(String tableName) {
        YesOrNoEnum autoRemovePre = GenConfig.autoRemovePre;
        String tablePrefix = GenConfig.tablePrefix;
        if (YesOrNoEnum.YES.equals(autoRemovePre) && StringUtils.isNotEmpty(tablePrefix)) {
    ...
    public static Integer getColumnLength(String columnType) {
        if (StringUtils.indexOf(columnType, "(") > 0) {
            ...
            if (length.contains(",")) {
                return Integer.valueOf(length.split(",")[0]);
            }
